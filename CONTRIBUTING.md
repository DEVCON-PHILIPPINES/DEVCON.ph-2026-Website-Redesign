...
5. **Approve the deploy.** After the merge, the **Deploy to GitHub Pages** workflow waits for an admin to approve the `github-pages` environment, then publishes the site.
